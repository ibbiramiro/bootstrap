    ...
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-xl shadow-lg p-8">
            ...
            <form class="space-y-4">
                ...
                <div class="text-xs text-gray-500 text-left pt-2">
                    By signing up or logging in, you consent to DeepSeek's 
                    <a href="#" class="text-black underline">Terms of Use</a> and 
                    <a href="#" class="text-black underline">Privacy Policy</a>.
                </div>

                <!-- Login Button -->
                <div class="pt-4">
                    <button type="submit" class="w-full h-12 bg-[#4D6BFE] text-white rounded-lg font-medium hover:bg-[#3A5AE0] transition focus:outline-none focus:ring-2 focus:ring-[#4D6BFE] focus:ring-offset-2">
                        Log in
                    </button>
                </div>
                ...
                <div class="flex justify-between items-center pt-2">
                    <a href="#" class="text-sm text-[#4D6BFE] hover:underline">Forgot password?</a>
                    <a href="#" class="text-sm text-[#4D6BFE] hover:underline">Sign up</a>
                </div>
                ...
                <!-- Google Login Button -->
                <button type="button" class="w-full h-12 border border-gray-300 rounded-lg font-medium flex items-center justify-center hover:bg-gray-50 transition focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2">
